...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-heading','data' => ['title' => ''.e($section['title'][0]['name']).'','subtitle' => $section['subtitle']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($section['title'][0]['name']).'','subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($section['subtitle'])]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    <div class="grid grid-cols-1 mt-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 gap-y-8">
        <?php if(sizeOf($section['products']) < 8 and sizeOf($section['products']) > 4): ?>
            <?php for($i = 0; $i < 4; $i++): ?>
                <?php if (isset($component)) { $__componentOriginal3fd2897c1d6a149cdb97b41db9ff827a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3fd2897c1d6a149cdb97b41db9ff827a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.product-card','data' => ['product' => $section['products'][$i]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($section['products'][$i])]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="flex justify-center mt-10">
        <form method="GET" action="search">
            <input type="hidden" name="category" value="<?php echo e($section['id']); ?>">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Ver mas <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/html/resources/views/components/products-section.blade.php ENDPATH**/ ?>